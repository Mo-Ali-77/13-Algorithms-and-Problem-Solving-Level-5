...
public:
	...
	clsQueueLine(string Perfix, short AverageServerTime)
	{
		_Perfix = Perfix;
		_TotalTickets = 0;
		_AverageServerTime = AverageServerTime;
	}

	void IssueTicket()
	{
		++_TotalTickets;
        clsTicket Ticket(_Perfix, _TotalTickets, WaitingClients(), _AverageServerTime);
